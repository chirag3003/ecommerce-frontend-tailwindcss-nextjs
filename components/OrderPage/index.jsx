...
export default function Example() {
    ...
    useEffect(() => {
        ...
        auth.Axios.get("/order/"+id).then(res => {
            console.log(res)
            setOrder(res.data)
        }).catch(err => {
            console.error(err)
            ...
            <div className="max-w-3xl mx-auto">
                ...
                <div className="text-sm border-b border-gray-200 mt-2 pb-5 sm:flex sm:justify-between">
                    <dl className="flex">
                        ...
                        <dd className="font-medium text-indigo-600">{order?.orderID}</dd>
                        <dt>
                        ...
                        <dd className="font-medium text-indigo-600">
                            <time dateTime="2021-03-22">{new Date().toDateString()}</time>
                        </dd>
                    </dl>
                ...
                <div className="border-t border-gray-200 py-6 px-4 sm:px-6 lg:p-8">
                    ...
                    <p className="text-sm font-medium text-indigo-600">
                        {"status"} on <time dateTime={"2021-03-24"}>{new Date().toDateString()}</time>
                    </p>
                    ...
                    <div className="sm:ml-40 sm:pl-6">
                            ...
                            <div>
                                ...
                                <dd className="mt-2 text-gray-700">
                                    <address className="not-italic">
                                        ...
                                        <span className="block">{order?.address.addressLine2}</span>
                                    </address>
                                </dd>
                            </div>
                            <div>
                        ...
                        <dl className="space-y-6 border-t border-gray-200 text-sm pt-10">
                            ...
                            <div className="flex justify-between">
                                ...
                                <dd className="text-indigo-600">₹ {order?.amount}</dd>
                            </div>
                        </dl>
                    </div>
                </section>
